<template>
  <div class="h-[100%]">
    <el-container>
      ...
      <el-footer class="whitespace-pre-line h-28 leading-relaxed flex-shrink-0" v-html="footer">
      </el-footer>
    </el-container>
    <router-view />
  </div>
...
const footer = ref(
  `<a class="btnani text-base" href="mailto:neil.cwn20@gmail.com">neil.cwn20@gmail.com</a>\n<div class="relative w-[100%]">© ${date.value} Neil Chen</div> <img style="opacity: 0.2" src="https://www.f-counter.net/j/63/1708486094/" alt="計數器"><span class="float-right opacity-5 relative">v1.0.4</span>`
)
</script>
